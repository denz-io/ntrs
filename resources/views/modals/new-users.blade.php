<div class="modal fade" id="users-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-plus-square fa-lg"></i> Create User</h5>
      ...
      <div class="modal-body">
        <form action="/manage-users" method="POST">
            ...
            <div class="form-group">
                <input type="password" class="form-control form-custom" id="password" name="password" placeholder="Password" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group" style="text-align: center;">
                <button class="btn btn-success custom-button-radius" type="submit" href="#">Create User</button>
            </div>
        </form>
      </div>
    </div>
